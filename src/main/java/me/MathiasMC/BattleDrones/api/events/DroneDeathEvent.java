...
public class DroneDeathEvent extends Event implements Cancellable {
    ...
    public DroneDeathEvent(Player player, PlayerConnect playerConnect, DroneHolder droneHolder) {
        this.player = player;
