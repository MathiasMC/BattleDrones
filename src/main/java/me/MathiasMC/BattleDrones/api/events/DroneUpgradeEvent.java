...
public class DroneUpgradeEvent extends Event implements Cancellable {
    ...
    public DroneUpgradeEvent(Player player, PlayerConnect playerConnect, DroneHolder droneHolder) {
        this.player = player;
