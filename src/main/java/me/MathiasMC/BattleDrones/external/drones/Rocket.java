            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    if (shouldExplode) {
                        ...
                        final String worldX = Objects.requireNonNull(currentMissileLocation.getWorld()).getName();
                        ...
                        plugin.getServer().getScheduler().runTaskLater(plugin, () -> {
                            if (target.isDead()) {
                                ...
                                final String x = String.valueOf(currentMissileLocation.getBlockX());
                                final String y = String.valueOf(currentMissileLocation.getBlockY());
                                final String z = String.valueOf(currentMissileLocation.getBlockZ());
